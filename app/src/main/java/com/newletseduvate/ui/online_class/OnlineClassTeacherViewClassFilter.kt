...
class OnlineClassTeacherViewClassFilter(private val mFilter: Filter) : BaseDialogFragment(),
    SingleSelectionBottomSheetFragment.OnChooseReasonListener,
    View.OnClickListener {

    private lateinit var binding: FragmentOnlineClassTeacherViewClassFilterBinding
    private val viewModel by lazy {
        getViewModel<OnlineClassTeacherViewClassViewModel>(
            requireActivity()
        )
    }
    ...
    override fun onCreateView(
        ...
        binding =
            FragmentOnlineClassTeacherViewClassFilterBinding.inflate(inflater, container, false)
        return binding.root
    }
