...
import com.newletseduvate.databinding.FragmentOnlineClassTeacherResourcesBinding
...
class OnlineClassTeacherResourcesFragment : BaseFragment(R.layout.fragment_online_class_teacher_resources) {
    private lateinit var binding: FragmentOnlineClassTeacherResourcesBinding
    private val viewModel by lazy { getViewModel<OnlineClassTeacherResourcesViewModel>(requireActivity()) }

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentOnlineClassTeacherResourcesBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        callbacks.add(CallBackModel(R.id.btn_view_more) { model, position ->
            ...
            findNavController().navigate(R.id.nav_online_class_teacher_resources_details, bundle)
        })
    ...
    private fun goToFilter() {
        val filterFragment = OnlineClassTeacherResourcesFilter(object : OnlineClassTeacherResourcesFilter.Filter {
            override fun onDone(
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance() = OnlineClassTeacherResourcesFragment()
    }

    override fun onResume() {
        super.onResume()
        setToolBarTitle(getString(R.string.menu_resource))
    }
}