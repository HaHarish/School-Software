...
import com.newletseduvate.databinding.FragmentStudentHomeworkFilterBinding
...
class HomeworkStudentFilterFragment : BaseDialogFragment(),
    SingleSelectionBottomSheetFragment.OnChooseReasonListener,
    View.OnClickListener {

    private lateinit var mFilter: Filter

    private lateinit var binding: FragmentStudentHomeworkFilterBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentStudentHomeworkFilterBinding.inflate(inflater, container, false)
        return binding.root
    }
